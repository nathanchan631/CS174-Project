    ...
    update_state(dt) {
        ...
        while(this.bodies.length == 0)
        {
            ...
            this.bodies.push(new Body(this.shapes.cube, this.materials.ball.override({color: color(0,1,1,1)}), vec3(1, 1, 1))
                .emplace(Mat4.translation(...vec3(20, 6, 109)).times(Mat4.scale(1, 10, 4)), vec3(-4, 4, 4), 0));
            this.bodies.push(new Body(this.shapes.cube, this.materials.ball.override({color: color(0,1,1,1)}), vec3(1, 1, 1))
                .emplace(Mat4.translation(...vec3(20, 6, 131)).times(Mat4.scale(1, 10, 4)), vec3(-4, 4, 4), 0));
            this.bodies.push(new Body(this.shapes.cube, this.materials.ball.override({color: color(1,1,0,1)}), vec3(1, 1, 1))
                .emplace(Mat4.translation(...vec3(50, 6, 190)).times(Mat4.scale(3, 10, 0.6)), vec3(-4, 4, 4), 0));
            this.bodies.push(new Body(this.shapes.cube, this.materials.ball.override({color: color(1,1,0,1)}), vec3(1, 1, 1))
                .emplace(Mat4.translation(...vec3(57, 6, 190)).times(Mat4.scale(0.6, 10, 0.6)), vec3(-4, 4, 4), 0));
            this.bodies.push(new Body(this.shapes.cube, this.materials.ball.override({color: color(1,1,0,1)}), vec3(1, 1, 1))
                .emplace(Mat4.translation(...vec3(64, 6, 190)).times(Mat4.scale(3, 10, 0.6)), vec3(-4, 4, 4), 0));
            this.bodies.push(new Body(this.shapes.cube, this.materials.ball.override({color: color(0,1,0,1)}), vec3(1, 1, 1))
               .emplace(Mat4.translation(...vec3(110, 0, 235)).times(Mat4.scale(3.5, 1, 10)), vec3(-4, 4, 4), 0));
            this.bodies.push(new Body(this.shapes.cube, this.materials.ball.override({color: color(1,1,0,1)}), vec3(1, 1, 1))
               .emplace(Mat4.translation(...vec3(95, 6, 300)).times(Mat4.scale(3, 10, 1)), vec3(-4, 4, 4), 0));
            this.bodies.push(new Body(this.shapes.cube, this.materials.ball.override({color: color(1,1,0,1)}), vec3(1, 1, 1))
