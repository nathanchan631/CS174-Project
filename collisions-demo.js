...
export class Test_Data {
    ...
    constructor() {
        this.textures = {
            black: new Texture("assets/black.jpg"),
        }
        this.shapes = {
...
export class Collision_Demo extends Simulation {
    ...
    constructor() {
        ...
        // Materials:
        const phong = new defs.Phong_Shader(0);
        const bump = new defs.Fake_Bump_Map(0)
        this.inactive_color = new Material(bump, {
            color: color(1, 1, 1, 1), ambient: .2,
